...
class AddTrashBtn extends React.Component<{ erase: (newEraseTask: ReactNode) => void }> {
    ...
    addTrashTask() {
        ...
        let key_node = uuid();
        let erase_array = ["/home/{}/.local/share/Trash/info", "/home/{}/.local/share/Trash/files"];
...
class AddFileBtn extends React.Component {
    ...
    addFileTask() {
        ...
        const root = ReactDOM.createRoot(
            document.getElementById("modale-zone") as HTMLElement
        );
        root.render(
            <ModalForm isVisible={true} isFolder={false} />
        )
    }

    render() {
        return <div className='btn center-btn' onClick={this.addFileTask}>
